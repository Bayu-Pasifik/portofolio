  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-500 via-white to-blue-50 text-center px-4">
      ...
      <p className="mt-4 text-xl text-gray-600">
        Seorang <span className="font-semibold text-blue-600">Software Developer</span> dengan fokus pada <span className="font-semibold text-blue-600">Pengembangan Website dan Aplikasi Mobile</span>.
      </p>
    </main>
  );
};
